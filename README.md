...
| ----------------- | --------- | ----- | ----- |
| 2023-09-06 | Misty Wahl | Preview of Technical Paper presentation: Zero noise extrapolation on logical qubits by scaling the error correction code distance | [paper] (https://arxiv.org/abs/2304.14985), (Slides will be uploaded here after IEEE presentation)|
